 ...
 */
class Categorie extends \BibliothequeBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BibliothequeBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'BibliothequeBundle\\Entity\\Categorie' . "\0" . 'nom');
        }
